...
const {name, quantity, description, supplier, taste, category, details, photourl} = coffee ;
...
const handelUpdateCoffee = e => {
    ...
    const updatedCoffee = { name, quantity, description, supplier, taste, category, details, photourl };
...
headers: {
  ...
  .then(data => {
   ...
   if(data.modifiedCount > 0){
    ...
    return (
        <div>
        <h2 className='text-6xl font-bold flex justify-center mt-12'>Update coffee : {name} coffee</h2>
        <section className="p-6 bg-red-200 container mx-auto rounded-2xl mt-10 ">
            ...
            <form onSubmit={handelUpdateCoffee} className="container flex flex-col mx-auto space-y-12">
                ...
                <div className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-50">
                    ...
                    <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                        <div className="col-span-full sm:col-span-3">
                            ...
                            <input type="text" name='name' defaultValue={name} placeholder="Coffee name" className="w-full h-16 rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" />
                        </div>
                        <div className="col-span-full sm:col-span-3">
                            <label htmlFor="firstname" className="text-sm">Avialable Quantity</label>
                            <input type="text" name='quantity' defaultValue={quantity} placeholder="Avialable Quantity" className="w-full h-16 rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" />
                        </div>
                ...
                {/* ---------------------supplier and Taste------------------------------------------ */}
                <div className="grid grid-cols-4 gap-6 p-6 bg-red-300 rounded-md shadow-sm dark:bg-gray-50">
                    <div className="space-y-2  col-span-full lg:col-span-1">
                        <p className="font-bold text-4xl">Coffee Store</p>
                    ...
                    <div className="grid grid-cols-6 mt-36 gap-4 col-span-full lg:col-span-3">
                        <div className="col-span-full sm:col-span-3">
                            ...
                            <input type="text" name='supplier' defaultValue={supplier} placeholder="Supplier" className="w-full h-16 rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" />
                        </div>
                        <div className="col-span-full sm:col-span-3">
                            <label htmlFor="firstname" className="text-sm">Taste</label>
                            <input type="text" name='taste' defaultValue={taste} placeholder="Taste" className="w-full h-16 rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" />
                        </div>

                    </div>
                </div>
                {/* -------------------catagory And  Details form------------------------------------------- */}
                <div className="grid grid-cols-4 bg-red-400 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-50">
                    <div className="space-y-2  col-span-full lg:col-span-1">
                        <p className="font-bold text-4xl">Coffee Store</p>
                    ...
                    <div className="grid grid-cols-6 mt-36 gap-4 col-span-full lg:col-span-3">
                        <div className="col-span-full sm:col-span-3">
                            ...
                            <input type="text" name='category' defaultValue={category} placeholder="category" className="w-full h-16 rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" />
                        </div>
                        <div className="col-span-full sm:col-span-3">
                            <label htmlFor="firstname" className="text-sm">Details</label>
                            <input type="text" name='details' defaultValue={details} placeholder="details" className="w-full h-16 rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" />
                        </div>

                    </div>
                </div>
                {/* -------------------------------------------------------------- */}
                <div className="grid grid-cols-4   bg-red-500 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-50">
                    ...
                    <div className="grid grid-cols-6 mt-36 gap-4 w-full mb-36 col-span-full lg:col-span-3">
                        <div className=" sm:col-span-3 w-full">
                            ...
                            <input type="text" name='photourl' defaultValue={photourl} placeholder="Photo Url" className="w-full  h-16 rounded-md   dark:text-gray-50 " />
                        </div>
                ...
                <input className='text-3xl font-bold  btn btn-block' type="submit" value="Update Coffee" />
